...
ARTEFACT_JOB_ADVERTS_DIR = RAW_DIR / "artefact" / "job_adverts"
ARTEFACT_MULTI_JOB_SUMMARY_PATH = ARTEFACT_DIR / "multi_job_match_summary.txt"
ARTEFACT_MULTI_JOB_RESULTS_PATH = ARTEFACT_DIR / "multi_job_match_results.json"
ARTEFACT_GENERATED_DICTIONARY_PATH = ARTEFACT_DIR / "esco_skill_dictionary.json"
WEAK_LABELLED_REED_LARGE_V3_PATH = PROCESSED_DIR / "distilbert" / "weak_labelled_reed_large_v3.jsonl"

DISTILBERT_REED_LARGE_V3_5EPOCH_RESULTS_PATH = (
    PROCESSED_DIR / "distilbert" / "distilbert_reed_large_v3_5epoch_results.txt"
)

DISTILBERT_REED_LARGE_V3_5EPOCH_MODEL_DIR = (
    PROCESSED_DIR / "distilbert" / "reed_large_v3_5epoch_model_output"
)